...
export default function ServicesAndToolsSection({
  ...
  const selectedCategories = selectedCell?.toolCategories?.length
    ? CATEGORY_ORDER.filter((c) => selectedCell.toolCategories!.includes(c))
    : []
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed max-w-2xl">
                    ...
                    <strong className="text-slate-800">agentic development workflow</strong>
                    — AI-assisted coding, iterative refinement, and automated quality checks.
                  </p>
                  {platforms.length > 0 && (
