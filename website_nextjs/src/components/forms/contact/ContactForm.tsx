  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
      ...
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-2">{contactData.form.title}</h3>
        <p className="text-gray-600 mb-6">{contactData.form.subtitle}</p>
        ...
        >
          {isFormOpen ? 'Hide Form' : 'Show Contact Form'} 
      ...
      >
        ...
        <div>
          ...
          >
            {contactData.form.fields.projectType.options.map((option) => (
        ...
        <div>
          ...
          <div>
            ...
            >
              {contactData.form.fields.budget.options.map((option) => (
                <option key={option.value} value={option.value}>
                  {option.text}
                </option>
              ))}
